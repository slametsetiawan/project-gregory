  ...
  <div class="content_bg">
    <div class="mainbar">
      <div class="article">
        ...
        <img src="<?php echo $GLOBALS["url"]; ?>/style/images/images_1.jpg" width="613" height="193" alt="image" /><p>This is a free CSS website template by <a href="http://www.rocketwebsitetemplates.com/" title="Website Templates">RocketWebsiteTemplates.com</a>. This 
...
which means that you are free to use it for any personal or commercial purpose provided you credit me in the form of a link back to <a href="http://www.rocketwebsitetemplates.com/" title="Website Templates">RocketWebsiteTemplates.com</a>.</p>
      ...
      <div class="pagenavi"><span class="pages">Page 1 of 2</span>
      <span class="current">1</span><a href="#" title="2">2</a><a href="#">»</a></div>
    </div>
    <div class="sidebar">
      <div class="gadget">
        <h2 class="star"><span>Sidebar</span> Menu</h2>
        <div class="clr"></div>
        <ul class="sb_menu"><li class="active"><a href="#">Home</a></li>
      ...
      <div class="gadget">
        ...
        <div class="clr"></div>
        <ul class="ex_menu"><li class="active"><a href="http://www.dreamtemplate.com/">DreamTemplate<br />
      ...
      <div class="gadget">
        ...
        <div class="testi">
          <p><span class="q">
          <img src="<?php echo $GLOBALS["url"]; ?>/style/images/qoute_1.gif" width="20" height="15" alt="quote" />
          </span> We can let circumstances rule us, or we can take charge and rule our lives from within. <span class="q">
          <img src="<?php echo $GLOBALS["url"]; ?>/style/images/qoute_2.gif" width="20" height="15" alt="quote" /></span></p>
