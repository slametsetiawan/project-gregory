...
--
-- Host: localhost
-- Generation Time: Mar 19, 2012 at 01:33 PM
...
(1, 'PB01', 'NEW POLO BURBERRY IMPORT', 3, 'Ukuran M', 0.5, 125000, 23),
(2, 'JBB2', 'JEANS BURBERRY', 1, 'Ukuran All size', 0.3, 340000, 37),
(3, 'JG001', 'JEANS GUESS PREMIUM', 2, 'ukuran All siza', 0.35, 320000, 65),
(4, 'KSG1', 'KEMEJA GUESS PENDEK PREMIUM', 2, 'ukuran All siza', 0.18, 230000, 41),
(5, 'PGS3', 'POLO SHIRT GUESS PREMIUM', 2, 'Ukuran All size', 0.22, 160000, 38),
(6, 'TGS3', 'T-SHIRT GUESS PREMIUM', 2, 'Ukuran All size', 0.2, 135000, 44);
